...
<body>
	<div id="inscription"> 
		<form method="post" id="formulaire_inscription">
			...
			<div id="nom_prenom_inscription" class="inscription_partie">
				<div id="nom_inscription">
					<label id="inscription_nom_label" class="inscription_label">Nom</label>
					<input type="text" id="inscription_nom_input" class="inscription_nom_prenom" name="nom">
				</div>
				
				<div id="prenom_inscription">
					<label id="inscription_prenom_label" class="inscription_label">Prenom</label>
					<input type="text" id="inscription_prenom_input" class="inscription_nom_prenom" name="prenom">
				</div>
			</div>
			
			<div id="email_emailconfirm_inscription" class="inscription_partie">
				<div id="email_inscription">
					<label id="inscription_email_label" class="inscription_label">Email</label>
					<input type="text" id="inscription_email_input" class="inscription_email" name="email">
				</div>
				
				<div id="confirm_email_inscription">
					<label id="inscription_confirm_email_label" class="inscription_label">Confirm Email</label>
					<input type="text" id="inscription_confirm_email_input" class="inscription_email" name="confirm_email">
				</div>
			</div>
			
			<div id="password_confirm_password_inscription" class="inscription_partie">
				<div id="inscription_password">
					<label id="inscription_password_label" class="inscription_label">Password</label>
				...
				<div id="inscription_password_confirm">
					<label id="inscription_password_confirm_label" class="inscription_label">Confirm Password</label>
